...
<title>egou Administrator's Control Panel - powered by egou</title>
<link href="/res/togogo/css/admin.css" rel="stylesheet" type="text/css"/>
...
<script src="/res/common/js/togogo.js" type="text/javascript"></script>
<script src="/res/togogo/js/admin.js" type="text/javascript"></script>
<style type="text/css">        
*{margin:0;padding:0}
...
.topbg{background:url(/res/togogo/img/admin/top-tbg.png) no-repeat; height:38px;}
.login-welcome{padding-left:20px; color:#fff; font-size:12px;background:url(/res/togogo/img/admin/topbg.gif) no-repeat;}
...
.nav-menu{background:url(/res/togogo/img/admin/bg.png) repeat-x; height:31px; list-style:none; padding-left:20px; font-size:14px;}
.nav .current {background: url(/res/togogo/img/admin/navcurrbg.gif) no-repeat 0px 2px; color:#fff; width:72px; text-align:center;} 
.nav .current a{color:#fff;}
.nav-menu li {height:31px;text-align:center; line-height:31px; float:left; }
.nav-menu li a{color:#2b2b2b; font-weight:bold;}
.nav-menu li.sep{background: url(/res/togogo/img/admin/step.png) no-repeat; width:2px; height:31px; margin:0px 5px;}
.nav .normal{width:72px; text-align:center;}
.top-bottom{width:100%; background: url(/res/togogo/img/admin/bg.png) repeat-x 0px -34px; height:3px;}
.undis{display:none;}
.dis{display:block;}
</style>
...
<div id="top">
     <div class="top">
          ...
          <tr>
            <td width="215"><div class="logo"><img src="/res/togogo/img/admin/logo.png" width="215" height="69" /></div></td>
            <td valign="top">
                <div class="topbg">
                     <div class="login-welcome">
                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <img src="/res/togogo/img/admin/welconlogin-icon.png"/><span id="welcome">您好:admin!</span>
                                    <img src="/res/togogo/img/admin/loginout-icon.png"/><a href="logout.do?returnUrl=index.do" target="_top" id="logout" onclick="return confirm('您确定退出吗?');">退出</a> 
                                    <img src="/res/togogo/img/admin/message-unread.png"/>&nbsp;<a href="message/v_list.do" target="rightFrame">你有<span id="countDiv">0</span>条信息未读</a>
                                    </td>
                                  </tr>
                                </table>
                       </div>  
                     <div class="nav">
                     	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td style="background-image:url('/res/togogo/img/admin/nav-left.png')" width="14" height="31"></td>
                                <td>
                                	<ul class="nav-menu">
